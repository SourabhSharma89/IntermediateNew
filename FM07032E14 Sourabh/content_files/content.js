	...
	randRange = function (min, max) {
				...
				quesGeneration = function(){
				          ...
				          for (var i = 0; i<array_Range; i++) {
							...
							QuestionFinal = `<span class='bracket'>[</span>&nbsp;${num5}<span style='visibility:hidden;'>1</span>+<span style='visibility:hidden;'>1</span><span class='bracket'>(</span> – ${num2}<div class='fraction bold'><span class='fup'> ${num3} </span><span class='fdn1'> ${num41} </span></div> <span class='bracket'>)</span> <span class='bracket'> ]</span><span class='Power'><sup><small> 2</small></sup></span><span style='visibility:hidden;'>1</span>–<span style='visibility:hidden;'>1</span><span class='bracket'>(</span> – <div class='fraction bold'><span class='fup'> ${num7} </span><span class='fdn1'> ${num8} </span></div> <span class='bracket'>)</span> <span style='visibility:hidden;'>1</span>+<span style='visibility:hidden;'>1</span><span style='visibility:hidden;'>1</span>${num6}<div class='fraction bold'><span class='fup'> ${num7} </span><span class='fdn1'> ${num8*2} </span></div>`
							
							QuestionFinalSol = `<span class='deeppink'><span class='bracket'>[</span>&nbsp;${num5}<span style='visibility:hidden;'>1</span>+<span style='visibility:hidden;'>1</span><span class='bracket'>(</span> – ${num2}<div class='fraction bold'><span class='fup'> ${num3} </span><span class='fdndeeppink'> ${num41} </span></div> <span class='bracket'>)</span> <span class='bracket'> ]</span><span class='Power'><sup><small> 2</small></sup></span></span><span style='visibility:hidden;'>1</span>–<span style='visibility:hidden;'>1</span><span class='green'><span class='bracket'>(</span> – <div class='fraction bold'><span class='fup'> ${num7} </span><span class='fdngreen'> ${num8} </span></div> <span class='bracket'>)</span></span> <span style='visibility:hidden;'>1</span>+<span style='visibility:hidden;'>1</span><span style='visibility:hidden;'>1</span><span class='blueneed'>${num6}<div class='fraction bold'><span class='fup'> ${num7} </span><span class='fdnblue'> ${num8*2} </span></div></span>`
							
							var Fract1 = MixedtoProper(num2,num3,num41)
							calculation1=Fract1[1]*num5-Fract1[0]
							var Fract2 = MixedtoProper(num6,num7,num41*2)
							
							var CalculationFinal = num1*Fract1[1]**2+calculation1**2+Fract2[0]*(Fract1[1]);
							var CalculationFinal2 = Fract1[1]**2;
							
							
							FindLCm = getLCM(num41**2,num41,num41*2);
							Element1 = FindLCm/(num41**2);
							Element2 = FindLCm/(num41)
							Element3 = FindLCm/(num41*2)
							FirstP = Element1*calculation1**2;
							FirstP1 = Element2*num7;
							FirstP2 = Element3*Fract2[0];
							FinalCalculationForAns = Number(FirstP)+Number(FirstP1)+Number(FirstP2);
							FinalCalculationForAns2 = FindLCm;
							var FinalCal = properToMixed([FinalCalculationForAns,FinalCalculationForAns2])
							
							
							QuestionFina12 = `<span class='deeppink'><span class='bracket'>( </span><div class='fraction bold'><span class='fup'> ${calculation1} </span><span class='fdndeeppink'> ${Fract1[1]} </span></div><span class='bracket'> )</span><span class='Power'><sup><small> 2</small></sup></span></span><span style='visibility:hidden;'>1</span>+<span style='visibility:hidden;'>1</span><span class='green'><div class='fraction bold'><span class='fup'> ${num7} </span><span class='fdngreen'> ${num8} </span></div></span><span style='visibility:hidden;'>1</span>+<span style='visibility:hidden;'>1</span><span class='blue'><div class='fraction bold'><span class='fup'> ${Fract2[0]} </span><span class='fdnblue'> ${Fract2[1]} </span></div></span>`
							
							QuestionFina13 = `<div class='fraction bold'><span class='fup'> ${calculation1**2} </span><span class='fdn'> ${Fract1[1]**2}</span></div><span style='visibility:hidden;'>1</span>+<span style='visibility:hidden;'>1</span><div class='fraction bold'><span class='fup'> ${num7} </span><span class='fdn1'> ${num8} </span></div><span style='visibility:hidden;'>1</span>+<span style='visibility:hidden;'>1</span><div class='fraction bold'><span class='fup'> ${Fract2[0]} </span><span class='fdn'> ${Fract2[1]} </span></div>`
							
							
							QuestionFina14 = `<div class='fraction bold'><span class='fup'> ${FirstP} &nbsp;+&nbsp; ${FirstP1} &nbsp;+&nbsp; ${FirstP2}</span><span class='fdn'>${FindLCm}</span></div><span style='visibility:hidden;'>1</span>=<span style='visibility:hidden;'>1</span><div class='fraction bold'><span class='fup'>${FinalCalculationForAns}</span><span class='fdn'>${FinalCalculationForAns2}</span></div><span style='visibility:hidden;'>1</span>=<span style='visibility:hidden;'>1</span><span class='red'>${FinalCal[0]}<div class='fraction bold'><span class='fup'>${FinalCal[1]}</span><span class='fdn2'>${FinalCal[2]}</span></div></span>`
							//////////////////////////
							SideNote1 = `<span style='visibility:hidden;'>11</span><span class='deeppink'><span class='bracket'>(</span>&nbsp;${num5-1}<span style='visibility:hidden;'>1</span>+<span style='visibility:hidden;'>1</span><div class='fraction bold'><span class='fup'> ${Fract1[1]} </span><span class='fdndeeppink'> ${Fract1[1]} </span></div> <span style='visibility:hidden;'>1</span>–<span style='visibility:hidden;'>1</span>${num2}<span style='visibility:hidden;'>1</span>–<span style='visibility:hidden;'>1</span><div class='fraction bold'><span class='fup'> ${num3} </span><span class='fdndeeppink'> ${num41} </span></div> <span style='visibility:hidden;'>1</span>=<span style='visibility:hidden;'>1</span><div class='fraction bold'><span class='fup'> ${calculation1} </span><span class='fdndeeppink'> ${Fract1[1]} </span></div> <span class='bracket'>)</span></span>`
							
								
					if (num5>num2 && num3<num41  && num7<num41  && num3!=num7 && getGCF1x(num3,num41)==1 && getGCF1x(num7,num41*2)==1 && getGCF1x(num7,num41)==1 && getGCF1x(FinalCalculationForAns,FinalCalculationForAns2)==1 && FinalCalculationForAns/FinalCalculationForAns2>1 && String(FinalCalculationForAns).length==2) { 
							R1_Arr.push(num1+"@"+num2+"@"+num3+"@"+num41+"@"+num5+"@"+num6+"@"+num7+"@"+num8+"@"+QuestionFinal+"@"+QuestionFina12+"@"+QuestionFina13+"@"+QuestionFina14+"@"+FinalCal[0]+"@"+FinalCal[1]+"@"+FinalCal[2]+"@"+QuestionFinalSol+"@"+SideNote1);
					} else {i--}
					}
